        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-cyan-50 flex items-center justify-center p-6">
            <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                ...
                <p className="text-center text-slate-600 text-lg mb-8">
                    Thank you for choosing the <span className="font-bold text-[#7000FF]">{plan.name}</span>
                </p>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-slate-600 leading-relaxed">
                                    Your customized {plan.duration} hair wellness plan will be sent to <span className="font-semibold text-slate-900">{email}</span> within the next <span className="font-bold text-[#7000FF]">24 hours</span>.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-slate-50 rounded-2xl p-6 mb-8">
                    ...
                    <div className="border-t border-slate-200 pt-3 mt-3 flex justify-between items-center">
                        ...
                        <span className="font-black text-2xl text-[#7000FF]">${plan.price}</span>
                    </div>
                </div>
